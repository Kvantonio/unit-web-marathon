...
fetch(requestUrl).then(
    ...
    for (let i = 0; i < 5; i++) {
        ...
        if (days[i].children[1].getAttribute("alt") == "Rain") {
            days[i].children[1].src = "assets/images/rain.png"
        }
        if (days[i].children[1].getAttribute("alt") == "Rain") {
            days[i].children[1].src = "assets/images/rain.png"
        }
        if (days[i].children[1].getAttribute("alt") == "Clear") {
            days[i].children[1].src = "assets/images/sun.jpg"
        }
        if (days[i].children[1].getAttribute("alt") == "Drizzle") {
            days[i].children[1].src = "assets/images/rain.png"
        }
        if (days[i].children[1].getAttribute("alt") == "Thunderstorm") {
            days[i].children[1].src = "assets/images/windy.png"
        }
        //add new images Thunderstorm
    }
